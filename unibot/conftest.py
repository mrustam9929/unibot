...
from unibot.db.dependencies import get_db_session
from unibot.db.utils import create_database, drop_database
from unibot.services.rabbit.dependencies import get_rmq_channel_pool
from unibot.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from unibot.services.redis.dependency import get_redis_pool
from unibot.settings import settings
from unibot.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from unibot.db.meta import meta  # noqa: WPS433
    from unibot.db.models import load_all_models  # noqa: WPS433
